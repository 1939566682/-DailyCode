...
import org.example.hjycommunity.common.utils.ExcelUtils;
import org.example.hjycommunity.community.domain.dto.HjyCommunityDTO;
import org.example.hjycommunity.community.domain.dto.HjyCommunityExcelDto;
...
public class ExportExcelController extends BaseController {
    ...
    public BaseResponse<String> exportExcel(HjyCommunity hjyCommunity, HttpServletResponse response) {
        ...
        ExcelUtils.exportExcel(excelDtoList, HjyCommunityExcelDto.class, "小区信息.xls",
